...
- All signed-in users: live signal feed and 7-day history with no intentional public delay.
- Paid users: existing subscription/payment status remains available in the account dashboard.
