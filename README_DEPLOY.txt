...
- Set KETS_DISABLE_SOURCE_BRIDGE = 1 if using direct bot -> website POST delivery as the primary connection.
- The older KETS_SIGNAL_SOURCE_URL / KETS_SIGNAL_SOURCE_KEY pull bridge remains available for compatibility/fallback.
